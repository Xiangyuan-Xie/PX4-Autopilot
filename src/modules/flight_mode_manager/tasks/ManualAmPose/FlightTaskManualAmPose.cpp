/****************************************************************************
 *
 * Flight task for AM Pose manual setpoint generation.
 *
 ****************************************************************************/

#include "FlightTaskManualAmPose.hpp"
...
constexpr float FlightTaskManualAmPose::kExpo;
constexpr float FlightTaskManualAmPose::kYawErrorTimeConstant;
constexpr float FlightTaskManualAmPose::kYawErrorChangeThreshold;

bool FlightTaskManualAmPose::activate(const trajectory_setpoint_s &last_setpoint)
{
...
bool FlightTaskManualAmPose::updateInitialize()
{
	_sticks_data_required = true;
...
bool FlightTaskManualAmPose::update()
{
...
void FlightTaskManualAmPose::_setDefaultConstraints()
{
...
bool FlightTaskManualAmPose::_checkTakeoff()
{
	return _sticks.getThrottleZeroCentered() > 0.3f;
}

void FlightTaskManualAmPose::_ekfResetHandlerHeading(float delta_psi)
{
...
void FlightTaskManualAmPose::scaleSticks()
{
...
void FlightTaskManualAmPose::updateYawSetpoint()
{
...
bool FlightTaskManualAmPose::updateYawCorrection(float yaw, float unaided_yaw, float dt_s)
{
...
float FlightTaskManualAmPose::updateYawLock(float yaw, float yawspeed_setpoint, float yaw_setpoint,
...
void FlightTaskManualAmPose::updateXYLock()
{
...
void FlightTaskManualAmPose::updateAltitudeLock()
{
...
void FlightTaskManualAmPose::respectMinAltitude()
{
	if (PX4_ISFINITE(_dist_to_bottom) && _dist_to_bottom < _min_distance_to_ground) {
...
void FlightTaskManualAmPose::terrainFollowing(bool apply_brake, bool stopped)
{
...
void FlightTaskManualAmPose::respectMaxAltitude()
{
...
void FlightTaskManualAmPose::respectGroundSlowdown()
{
...
void FlightTaskManualAmPose::updateSetpoints()
{
	updateYawSetpoint();
	updateAltitudeLock();
